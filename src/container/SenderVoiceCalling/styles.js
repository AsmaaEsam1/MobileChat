...
FabVideo:{
    backgroundColor:color.PRIMARY,marginHorizontal: 200
},
FabMic:{
    backgroundColor:color.PRIMARY,position:'relative' ,marginRight:175
},
FabVolumHigh:{
    backgroundColor:color.PRIMARY,position:'relative' ,marginRight:350
},
})